...
{
       0,   255,   255,   255,   257,   258,   259,   260,   261,   262,
...
{
  "$end", "error", "$undefined", "ID", "CMD", "SOURCE", "INCLUDE",
  "EXTENSIONS", "OBJECT", "BIN", "NAME", "$accept", "definitions",
...
#line 257 "config_parser.y"
                       { add (SOURCE_,     (yyvsp[0].str)); }
#line 1536 "y.tab.c"
    break;

  case 5:
#line 258 "config_parser.y"
                           { add (INCLUDE_,    (yyvsp[0].str)); }
#line 1542 "y.tab.c"
    break;

  case 6:
#line 259 "config_parser.y"
                           { add (OBJECT_,     (yyvsp[0].str)); }
#line 1548 "y.tab.c"
    break;

  case 7:
#line 260 "config_parser.y"
                           { add (EXTENSIONS_, (yyvsp[0].str)); }
#line 1554 "y.tab.c"
    break;

  case 8:
#line 261 "config_parser.y"
                           { add (BIN_,        (yyvsp[0].str)); }
#line 1560 "y.tab.c"
    break;

  case 9:
#line 262 "config_parser.y"
                           { add (NAME_,       (yyvsp[0].str)); }
#line 1566 "y.tab.c"
    break;

  case 10:
#line 263 "config_parser.y"
                           { add_cmd (SOURCE_,     (yyvsp[0].str)); }
#line 1572 "y.tab.c"
    break;

  case 11:
#line 264 "config_parser.y"
                           { add_cmd (INCLUDE_,    (yyvsp[0].str)); }
#line 1578 "y.tab.c"
    break;

  case 12:
#line 265 "config_parser.y"
                           { add_cmd (OBJECT_,     (yyvsp[0].str)); }
#line 1584 "y.tab.c"
    break;

  case 13:
#line 266 "config_parser.y"
                           { add_cmd (EXTENSIONS_, (yyvsp[0].str)); }
#line 1590 "y.tab.c"
    break;

  case 14:
#line 267 "config_parser.y"
                           { add_cmd (BIN_,        (yyvsp[0].str)); }
#line 1596 "y.tab.c"
    break;

  case 15:
#line 268 "config_parser.y"
                           { add_cmd (NAME_,       (yyvsp[0].str));}
#line 1602 "y.tab.c"
    break;
