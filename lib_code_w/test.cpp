...
void test_preproc(void)
{
    ...
    cw._endif();
    cw.flush();
    assert_file("main.cpp", "preproc.txt");
    remove("main.cpp");
}
...
void test_objects(void)
{
    ...
    cw._end_object();
    cw.flush();
    assert_file("main.cpp", "objects.txt");
    remove("main.cpp");
}
...
void test_instructions(void)
{
    ...
    cw.do_while("true");
    cw.flush();
    assert_file("main.cpp", "instructions.txt");
    remove("main.cpp");
}
...
void test_comments(void)
{
    ...
    cw.flush();
    assert_file("main.cpp", "comments.txt");
    remove("main.cpp");
}
